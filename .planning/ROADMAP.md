...
- [x] **Phases 7–8 (Milestone v1.1)** — Review follow-ups cleanup + codex self-fix fallback (shipped 2026-05-29, see [`milestones/v1.1-ROADMAP.md`](milestones/v1.1-ROADMAP.md))
...
| 7. Review follow-ups cleanup (v1.1) | 3/3 | Complete   | 2026-05-28 |
| 8. Codex self-fix fallback (v1.1) | 3/3 | Complete   | 2026-05-29 |
...
### ✅ Milestone v1.1 — SHIPPED 2026-05-29 (phases 7–8)

Hardening + codex self-fix fallback. 2 phases, 6 plans, 6 requirements (ZAP-55..60).
Archive: [.planning/milestones/v1.1-ROADMAP.md](milestones/v1.1-ROADMAP.md) · [.planning/milestones/v1.1-REQUIREMENTS.md](milestones/v1.1-REQUIREMENTS.md) · Git tag `v1.1`.

---
*Roadmap created: 2026-05-27*
*Phase 1 planned: 2026-05-27 — 5 plans across 3 waves*
*Milestone v1.1 archived: 2026-05-29 — 6 plans across phases 7–8*
